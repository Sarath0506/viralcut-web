...
export function CampaignDetailPage() {
  ...
  const submissionsPath = isAdmin ? "/admin/submissions" : "/submissions";
  ...
  return (
    <>
      ...
      {campaign.coverImageUrl ? (
        <div className="relative mb-6 aspect-[21/9] w-full overflow-hidden rounded-xl border border-border bg-surface-variant">
          <img
